...
public class TaskItem {
    ...
    public void setTaskDate(String taskDate) throws InvalidNameException {
        if(isDateValid(taskDate))
            this.taskDate = taskDate;
        else
            throw new InvalidNameException("Date is not valid.");
    }

    public void setTaskDescription(String taskDescription) throws InvalidNameException {
        if(isDescValid(taskDescription))
            this.taskDescription = taskDescription;
        else
            throw new InvalidNameException("Description is not valid");
    }

    public void setTaskTitle(String taskTitle) throws InvalidNameException {
        if(isTitleValid(taskTitle))
            this.taskTitle = taskTitle;
        else
            throw new InvalidNameException("Title is not valid");
    }
